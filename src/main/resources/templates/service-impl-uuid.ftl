...
public class ${className} implements ${serviceClassName} {
    ...
    public int save(List<${modelClassName}> ${modelObjectName}List) throws BusinessException {
        return ${mapperObjectName}.insertUuidList(${modelObjectName}List);
    }
     ...
     */
    @Override
    public ${modelClassName} get(String uuid) {
        return ${mapperObjectName}.selectByPrimaryKey(uuid);
    }
    ...
    public int delete(String uuid) {
        // 物理删除
        // return coinMapper.deleteByPrimaryKey(uuid);
